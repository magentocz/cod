...
class Magentocz_Cashondelivery_Helper_Data extends Mage_Core_Helper_Data
{
    /**
     * Config path constants
     */
    const CONFIG_XML_PATH_COD_TAX_CLASS    = 'tax/classes/magentocz_cashondelivery_tax_class';
    const CONFIG_XML_PATH_COD_INCLUDES_TAX = 'tax/calculation/magentocz_cashondelivery_includes_tax';
    const CONFIG_XML_PATH_DISPLAY_COD      = 'tax/display/magentocz_cashondelivery_fee';
    ...
    public function getTotalAfterPosition()
    {
        if (!$this->_getTotalAfterPosition) {
            ...
            $codPos      = $positions['magentocz_cashondelivery'];
