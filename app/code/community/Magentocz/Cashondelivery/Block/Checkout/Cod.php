 ...
 * 
 */
class Magentocz_Cashondelivery_Block_Checkout_Cod extends Mage_Checkout_Block_Total_Default
{
    protected $_template = 'magentocz/cashondelivery/checkout/cashondelivery.phtml';
    ...
    {
        return Mage::helper('magentocz_cashondelivery')->displayCodBothPrices();
    }
    ...
    {
        return Mage::helper('magentocz_cashondelivery')->displayCodFeeIncludingTax();
    }
    ...
    {
        return $this->helper('magentocz_cashondelivery')->__('Cash on Delivery fee (Incl.Tax)');
    }
    ...
    {
        return $this->helper('magentocz_cashondelivery')->__('Cash on Delivery fee (Excl.Tax)');
    }
}
