...
class Magentocz_Cashondelivery_Block_Info extends Mage_Payment_Block_Info
{
    ...
    {
        parent::_construct();
        $this->setTemplate('magentocz/cashondelivery/info.phtml');
    }

    public function toPdf()
    {
        $this->setTemplate('magentocz/cashondelivery/pdf/info.phtml');
        return $this->toHtml();
    }
