...
class Magentocz_Cashondelivery_Model_Sales_Quote_TaxTotal extends Mage_Sales_Model_Quote_Address_Total_Tax
{
    public function collect(Mage_Sales_Model_Quote_Address $address)
    {
        ...
        $codTaxClass = Mage::helper('magentocz_cashondelivery')->getCodTaxClass($store);
        ...
        if ($codTaxClass) {
            if ($rate = $taxCalculationModel->getRate($request->setProductClassId($codTaxClass))) {
                if (!Mage::helper('magentocz_cashondelivery')->codPriceIncludesTax()) {
