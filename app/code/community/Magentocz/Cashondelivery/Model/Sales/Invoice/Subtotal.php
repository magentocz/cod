 ...
 *
 * @category   Magentocz
 * @package    Magentocz_Cashondelivery
 * @copyright  Jaromir Muller, https://twitter.com/jaromirmuller
 * @license    http://opensource.org/licenses/osl-3.0.php  Open Software License (OSL 3.0)
 * @author     Reinhard Schneidewind <schnere@bveml.net>
 */

class Magentocz_Cashondelivery_Model_Sales_Invoice_Subtotal extends Mage_Sales_Model_Order_Invoice_Total_Subtotal
{
